...
function convert() {
    ...
    let lengthString = `${inputValue} Meters = ${(lengthCon*inputValue).toFixed(3)} feet |    
                        ${inputValue} feet = ${(inputValue/lengthCon).toFixed(3)} meters`
    let volumeString = `${inputValue} Liters = ${(volumeCon*inputValue).toFixed(3)} Gallons |    
                        ${inputValue} Gallons = ${(inputValue/volumeCon).toFixed(3)} Liters`
    let massString = `${inputValue} Kilograms = ${(massCon*inputValue).toFixed(3)} Pounds |    
                        ${inputValue} Pounds = ${(inputValue/massCon).toFixed(3)} Kilograms`
